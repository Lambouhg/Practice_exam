...
fun ResetPasswordScreen(
    ...
    Column(modifier = Modifier.padding(16.dp)) {
        Text(text = stringResource(id = R.string.reset_password), style = MaterialTheme.typography.headlineMedium)
        ...
        Button(onClick = { viewModel.resetPassword(email, onResult) }) {
